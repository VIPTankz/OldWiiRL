...
from MarioKartEnvPtan import MarioKartEnv
...
class RainbowDQN(nn.Module):
    ...
    def load_checkpoint(self):
        ...
        self.load_state_dict(torch.load("current_model235392"))
...
if __name__ == "__main__":
    params = common.HYPERPARAMS['MarioKart']
    ...
    env = MarioKartEnv() #gym.make(params['env_name'])
    ...
    agent = ptan.agent.DQNAgent(lambda x: net.qvals(x), ptan.actions.EpsilonGreedyActionSelector(), device=device)#ptan.actions.ArgmaxActionSelector()
